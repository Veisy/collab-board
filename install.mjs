...
// Usage:  node install.mjs [target-dir | --global | --codex-global]   (default: current directory)
//   e.g.  node install.mjs ../my-project     install into a project's .claude/
//         node install.mjs --global          install globally (~/.claude), any OS
//         node install.mjs --codex-global    install user-wide ($CODEX_HOME/skills, default ~/.codex/skills)
